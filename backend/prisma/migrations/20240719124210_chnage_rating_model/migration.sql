...
-- CreateIndex
CREATE INDEX "notification_user_id_restaurant_id_driver_id_idx" ON "notification"("user_id", "restaurant_id", "driver_id");
...
-- AddForeignKey
ALTER TABLE "notification" ADD CONSTRAINT "notification_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "driver"("id") ON DELETE SET NULL ON UPDATE CASCADE;
