...
import { emailValidationPattern, phoneValidationPattern, checkValidDate } from '../../Register/Validations/registervalidation';
...
const Profile: React.FC = () => {
  ...
  return (
    <div className="absolute top-28 right-96 h-700 bg-slate-400 p-8 rounded-lg">
      ...
      <form onSubmit={handleSubmit(handleupdate)} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="form-group">
            <label htmlFor="bd" className="block text-xl font-medium text-gray-700">
              DOB:
            </label>
            <input
              type="date"
        ...
        <button
          type="submit"
          className="ml-64 inline-flex justify-center py-3 px-10 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
          Update
        </button>
      </form>
