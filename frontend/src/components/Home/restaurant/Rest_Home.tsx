...
import { addmenuid, visible } from "../../redux-toolkit/Reducers/actions";
                    ...
                    {menuitem.map((data: MenuAttributes) => (
                        <div className="col_menu mb-5" key={data.id}>
                            ...
                            <div className="p-2 ml-7">
                                <p className="text-truncate text-xl ml-14  text-slate-500">{data.item_name}</p>
                                <p className="text-truncate  ml-14  text-slate-500">Rs.{data.price}</p>
                            </div>
